...
public class StockTaskService extends GcmTaskService {
    ...
    @IntDef({STOCKS_STATUS_OK, STOCKS_STATUS_SERVER_DOWN, STOCKS_STATUS_SERVER_INVALID, STOCKS_STATUS_UNKNOWN, STOCKS_STATUS_INVALID})
    ...
    public static final int STOCKS_STATUS_INVALID = 4;
            ...
            try {
                ...
                try {
                    ...
                    mContext.getContentResolver().applyBatch(QuoteProvider.AUTHORITY,
                            Utils.quoteJsonToContentVals(getResponse,mHandler,mContext));
