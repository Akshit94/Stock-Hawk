...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCursorAdapter = new QuoteCursorAdapter(this, null, emptyTextView);
        recyclerView.addOnItemTouchListener(new RecyclerViewItemClickListener(this,
                new RecyclerViewItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View v, int position) {
                        ...
                        detailIntent.putExtra(getString(R.string.intent_extra_symbol), tv.getText().toString());
                    ...
                    new MaterialDialog.Builder(mContext).title(R.string.symbol_search)
                            ...
                            .input(R.string.input_hint, R.string.input_prefill, new MaterialDialog.InputCallback() {
                                ...
                                public void onInput(MaterialDialog dialog, CharSequence input) {
                                    ...
                                    if (c.getCount() != 0) {
                                                Toast.makeText(MyStocksActivity.this, R.string.stock_already,
                                                        Toast.LENGTH_SHORT).show();
                                        return;
                                    } else {
                                        // Add the stock to DB
                                        mServiceIntent.putExtra(getString(R.string.tag), getString(R.string.add));
                                        mServiceIntent.putExtra(getString(R.string.symbol_small), input.toString().toUpperCase());
                                        startService(mServiceIntent);
                                    }
                                }
                            })
    ...
    private void updateEmptyView() {
        if (mCursorAdapter.getItemCount() == 0) {
            ...
            if (null != tv) {
                ...
                @StockTaskService.StocksStatus int location = Utils.getStocksStatus(getApplicationContext());
                switch (location) {
